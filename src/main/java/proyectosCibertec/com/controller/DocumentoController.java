...
public class DocumentoController {
	...
	public String eliminarDocumento(@PathVariable int id, Model model) {
	    try {
	        ...
	        model.addAttribute("mensaje", "Error al eliminar documento: " + e.getMessage());
	...
	public String registrarDocumento(@ModelAttribute Documentos documentos,
		...
		try {
			repoDocumentos.save(documentos);
			model.addAttribute("mensaje", "Documento registrado correctamente");
			model.addAttribute("css_mensaje", "alert alert-success");
		} catch (Exception e) {
			// TODO: handle exception
			model.addAttribute("mensaje", "Error al registrar documento:	" + e.getMessage());
			model.addAttribute("css_mensaje", "alert alert-danger");
		}
